...
const Contact = () => {
  ...
  const contactInfoItems = [
    ...
    },
    {
      ...
      value: contactInfo.whatsappNumber || whatsappNumber || '',
      action: () => {
        const number = contactInfo.whatsappNumber || whatsappNumber || '';
        if (!number) return;
        const message = isRTL
          ? 'مرحباً، أود التواصل معكم عبر واتساب'
          : 'Hello, I would like to contact you via WhatsApp';
