      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCrafts.map((craft) => (
            <Card
              key={craft.id}
              className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-white/80 backdrop-blur-sm border-0 shadow-lg relative"
              ...
              <CardContent className="p-0 flex flex-col flex-1">
                ...
                <div className="flex flex-col flex-1 p-6">
                  ...
                  <div className="min-h-[48px] flex flex-col justify-center">
                    ...
                    >
                      {craft.firstDescription?.trim() ? craft.firstDescription : ""}
                    </p>
                    <p
                      className={`text-sm text-muted-foreground line-clamp-1 text-center ${
                        isRTL ? "arabic-text" : ""
                    ...
                    >
                      {craft.secondDescription?.trim() ? craft.secondDescription : ""}
                    </p>
                  </div>
                ...
                {/* Hover Overlay covers the whole card, but does not hide shadow */}
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className={`text-gray-700 leading-relaxed ${isRTL ? "arabic-text text-right" : "text-left"}`}>
                    {selectedCraft.firstDescription?.trim() ? selectedCraft.firstDescription : ""}
                  </p>
                  {selectedCraft.secondDescription?.trim() && (
