...
const CraftsPage = () => {
  ...
  ...craft,
  id: craft.id,
  priceValue: craft.priceValue ?? 0, // Ensure priceValue is available
  ...
  const categoryOptions = useMemo<Array<{key: string; label: string}>>(() => [
        ...
        <div className="bg-transparent rounded-lg overflow-hidden">
          ...
          onSave={async (item: ManagementItem) => {
            ...
            const craftItem: Item = {
              ...
              priceValue: Number((item as any).priceValue ?? (item as any).price) || 0,
