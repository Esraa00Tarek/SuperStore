...
export default function Login() {
  ...
  <div className="min-h-screen flex items-center justify-center bg-[#f7f7f7] p-4 sm:p-6 lg:p-8">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#f7f7f7] p-8 text-center border-b border-gray-200">
        ...
        <CardContent className="p-6">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          className="pl-10 py-4 text-base border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary rounded-md"
                  </div>
                  <Input
                    id="password"
                    name="password"
          ...
          className="pl-10 pr-10 w-full py-4 rounded-md"
