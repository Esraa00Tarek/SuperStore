  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: t('auth.checkYourInbox') || 'Please check your inbox for the password reset link.',
      });
    } catch (err: any) {
      console.error('Password reset error:', err);
      setError(err.message || t('auth.resetFailed') || 'Failed to send password reset email');
      toast({
