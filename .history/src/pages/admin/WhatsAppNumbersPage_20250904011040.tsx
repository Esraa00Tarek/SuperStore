    ...
    <div className="container mx-auto p-4 md:p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">
          {isRTL ? 'إدارة أرقام واتساب' : 'WhatsApp Numbers Management'}
        </h1>
        <p className="text-muted-foreground">
          {isRTL 
            ? 'إضافة وإدارة أرقام واتساب للمنتجات والحرف اليدوية' 
            : 'Add and manage WhatsApp numbers for products and crafts'}
        </p>
      </div>
