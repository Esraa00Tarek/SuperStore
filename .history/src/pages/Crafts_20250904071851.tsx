              ...
              <CardContent className="p-0 flex flex-col flex-1">
                ...
                <div className="relative h-56 overflow-hidden rounded-2xl shadow-md">
                  <img
                    src={craft.image}
                    alt={craft.name}
                    className="w-full h-full object-contain rounded-2xl transition-transform duration-300 ease-in-out hover:scale-105"
                  />
          ...
          {selectedCraft && (
            <>
              ...
              <img
                ...
                className="w-full h-96 object-contain rounded-2xl shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 mb-0"
              />
              <p
