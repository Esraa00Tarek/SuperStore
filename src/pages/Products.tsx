  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
        <h1
          className={`text-2xl font-bold text-center mb-4 sm:mb-6 ${
            isRTL ? "arabic-text" : ""
          }`}
        >
          {t("nav.products")}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 px-1">
          {filteredProducts.map((product) => (
            <Card
              key={product.id}
              className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-white/80 backdrop-blur-sm border-0 shadow-lg relative mx-0.5 sm:mx-0"
      ...
      >
        <DialogContent className="w-full max-w-[90vw] sm:max-w-2xl mx-auto max-h-[90vh] overflow-auto p-4 sm:p-6">
          {selectedProduct && (
            <div className="space-y-6">
              ...
              {/* Image */}
              <div className="w-full h-60 sm:h-72 md:h-80 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg overflow-hidden">
                <img
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    handleWhatsAppOrder(selectedProduct.name, selectedProduct.seller)
                  }
                >
